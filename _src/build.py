...
<div class="rlb" id="reelBox" inert aria-hidden="true" role="dialog"
  ...
  <div class="rlb__bar">
    <button class="rlb__btn" type="button" data-rlb="toggle" aria-label="השהה">
      <svg class="rlb__pause" viewBox="0 0 24 24" aria-hidden="true"><rect x="7" y="5" width="3.4" height="14" rx="1.2"/><rect x="13.6" y="5" width="3.4" height="14" rx="1.2"/></svg>
      <svg class="rlb__play" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5.5v13L19 12z"/></svg>
    </button>
...
def patch_home():
    ...
    for tag, blk in (('nav', NAV), ('menu', MENU), ('contact', CONTACT),
                     ('footer', FOOTER), ('seo', home_seo()), ('wa', wa), ('rlb', rlb)):
